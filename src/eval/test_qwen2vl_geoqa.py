...
model_path= f"{r1_v_path}/src/r1-v/output/checkpoint-1004"
MODEL_PATH=model_path # qwen2vl model or grpoed model on geoqa train
BSZ=50 # reduce it if GPU OOM
OUTPUT_PATH=f"{r1_v_path}/src/eval/output/train@geo170k/eval/res@checkpoint-1004.json"
PROMPT_PATH=f"{r1_v_path}/src/eval/prompts/geoqa_test_prompts.jsonl"
