...
# MODEL_PATH="/newdisk/public/wws/00-Model-AIGC/Qwen2-VL-2B-Instruct" # Qwen2vl-2b-Instruct for original scores
MODEL_PATH="/newdisk/public/wws/01-AIGC-GPRO/R1-V-main/data/Qwen2-VL-2B-Instruct-SFT"
BSZ=32 # reduce it if GPU OOM
OUTPUT_PATH="/newdisk/public/wws/01-AIGC-GPRO/R1-V-main/src/eval/logs/test_counting_results_superclevr_200_qwen2vl_2b_instruct_group_100.json"
PROMPT_PATH="/newdisk/public/wws/01-AIGC-GPRO/R1-V-main/src/eval/prompts/superclevr_test200_counting_problems.jsonl"
...
for i in tqdm(range(0, len(messages), BSZ)):
    ...
    # 2-d 检查 token_type_ids（可选）
    # assert 0 in torch.unique(inputs.token_type_ids)
